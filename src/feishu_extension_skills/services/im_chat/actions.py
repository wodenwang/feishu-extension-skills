...
FEISHU_CHAT_DELETE = "feishu.chat.delete"
...
ACTION_HANDLERS: dict[str, Callable[..., dict[str, Any]]] = {
    ...
    FEISHU_CHAT_DELETE: delete_chat_action,
...
def register_actions(registry: Any, service: ImChatService | None = None) -> None:
    ...
    registry.register(
        FEISHU_CHAT_DELETE,
        _wrap_handler(delete_chat_action, service),
        description="Delete or dissolve a Feishu chat",
    )
    registry.register(
